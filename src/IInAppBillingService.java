   ...
   private static class Proxy implements com.android.vending.billing.IInAppBillingService
   {
     ...
     @Override public android.os.Bundle getBuyIntentV2(int apiVersion, java.lang.String packageName, java.lang.String sku, java.lang.String type, java.lang.String developerPayload) throws android.os.RemoteException
     {
       ...
       try {
         ...
         _data.writeString(type);
         _data.writeString(developerPayload);
         boolean _status = mRemote.transact(Stub.TRANSACTION_getBuyIntentV2, _data, _reply, 0);
         _reply.readException();
         _result = _Parcel.readTypedObject(_reply, android.os.Bundle.CREATOR);
       }
       finally {
     ...
     @Override public android.os.Bundle getPurchaseConfig(int apiVersion) throws android.os.RemoteException
     {
       ...
       try {
         _data.writeInterfaceToken(DESCRIPTOR);
         _data.writeInt(apiVersion);
         boolean _status = mRemote.transact(Stub.TRANSACTION_getPurchaseConfig, _data, _reply, 0);
         _reply.readException();
         _result = _Parcel.readTypedObject(_reply, android.os.Bundle.CREATOR);
       }
       finally {
